...
public class DrawingActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView image_a, image_b, image_c, image_d, image_e, image_f, image_g, image_h, image_i, image_j, image_k, image_l, image_m, image_n, image_o, image_p, image_q, image_r, image_s, image_t, image_u, image_v, image_w, image_x, image_y, image_z;
    TextView image_A, image_B, image_C, image_D, image_E, image_F, image_G, image_H, image_I, image_J, image_K, image_L, image_M, image_N, image_O, image_P, image_Q, image_R, image_S, image_T, image_U, image_V, image_W, image_X, image_Y, image_Z;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image_a = (TextView)findViewById(R.id.image_a);
        image_b = (TextView)findViewById(R.id.image_b);
        image_c = (TextView)findViewById(R.id.image_c);
        image_d = (TextView)findViewById(R.id.image_d);
        image_e = (TextView)findViewById(R.id.image_e);
        image_f = (TextView)findViewById(R.id.image_f);
        image_g = (TextView)findViewById(R.id.image_g);
        image_h = (TextView)findViewById(R.id.image_h);
        image_i = (TextView)findViewById(R.id.image_i);
        image_j = (TextView)findViewById(R.id.image_j);
        image_k = (TextView)findViewById(R.id.image_k);
        image_l = (TextView)findViewById(R.id.image_l);
        image_m = (TextView)findViewById(R.id.image_m);
        image_n = (TextView)findViewById(R.id.image_n);
        image_o = (TextView)findViewById(R.id.image_o);
        image_p = (TextView)findViewById(R.id.image_p);
        image_q = (TextView)findViewById(R.id.image_q);
        image_r = (TextView)findViewById(R.id.image_r);
        image_s = (TextView)findViewById(R.id.image_s);
        image_t = (TextView)findViewById(R.id.image_t);
        image_u = (TextView)findViewById(R.id.image_u);
        image_v = (TextView)findViewById(R.id.image_v);
        image_w = (TextView)findViewById(R.id.image_w);
        image_x = (TextView)findViewById(R.id.image_x);
        image_y = (TextView)findViewById(R.id.image_y);
        image_z = (TextView)findViewById(R.id.image_z);
        image_A = (TextView)findViewById(R.id.image_A);
        image_B = (TextView)findViewById(R.id.image_B);
        image_C = (TextView)findViewById(R.id.image_C);
        image_D = (TextView)findViewById(R.id.image_D);
